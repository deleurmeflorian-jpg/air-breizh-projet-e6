...
# ── CONFIG ────────────────────────────────────────────────
GPIO_FAN, GPIO_VERTE, GPIO_ROUGE, GPIO_ILS = 12, 13, 15, 11
GPIO_RELAIS   = 29       # Pin physique 29 (GPIO5)
CODE_SECRET   = "1234"
SEUIL_TEMP    = 26.0
SEUIL_PM25    = 25.0
...
def thread_digicode():
    ...
    log.info("Digicade - OK (verte=pin%d rouge=pin%d)", GPIO_VERTE, GPIO_ROUGE)
...
def thread_ils():
    ...
    log.info("ILS - OK pin%d", GPIO_ILS)
    precedent = None
    t_open = None
...
def thread_dht20():
    ...
    try:
        ...
        log.info("DHT20 - OK")
        log.info("RELAIS - OK pin%d (seuil %.1f C)", GPIO_RELAIS, SEUIL_TEMP)
